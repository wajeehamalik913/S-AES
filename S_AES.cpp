...
//A function prototype which is being used for the substitution of Bytes from the S_BOx
...
//A function prototype which is being used for the substitution of Bytes from the inv S_BOx
...
{
	//A function that will be actually
...
//a function that was suposed to XOR the given values
//and it is done in this way by using the Xor operator
void addRoundKey(unsigned char* state, unsigned char* roundKey)
{

	for (int i = 0; i < 16; i++)
	{	//a function that willl be used for the
...
//a function  that will do the left shift working
...
unsigned char getRoundCons(int u)
{
	...
	unsigned char round_cons[5] = { 0x01,0x02,0x04,0x08,
	0x10 };
	return round_cons[u];
}
...
{
	//a function prototypt that will be just
	//caling the user defined helper
	//function which will be calling furthur helper(user defined functions)
	int j = 0;
	int k = 0;
	for (int i = 0; i <= 4; i++)
	{
...
void FileHandling(string name)
{
	...
	cout <<endl<< "************READING MESSAGE FILE***********" << endl;
	for (int i = 0; i < 5; i++) {
		cout << "                  ..." << endl;
	}
...
int main()
{
	...
	cout << endl << "----------------------------------------------------------------------------------------------------" << endl;
	cout << "\t \t \t (AES Data Encryption/Decryption)" << endl ;
	cout << "----------------------------------------------------------------------------------------------------" << endl << endl;

	string filename;
	string c;
	cout << "Enter \"c\" to continue with encryption & decryption = ";
	getline(cin, c);
	if (c == "c" or "C") {
